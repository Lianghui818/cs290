...
function insertNewPost(description, photoURL, price, city, condition) {
    ...
    var insertNewPostHTML = Handlebars.templates.newPost(newCard);    //represents templates function

    // var postsSection = document.getElementById('posts');                    //insert new post and at bottom of the post div
    // postsSection.insertAdjacentHTML("beforeend", insertNewPostHTML);        //return insertNewPostHTML;
    
    var postsSection = document.getElementById('posts');
    postsSection.insertAdjacentHTML('beforeend', insertNewPostHTML);
  }
